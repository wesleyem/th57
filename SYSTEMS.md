...
#### Turbine Section
 ...
 - 2-stage gas producer turbine
    - N<sub>g</sub> and N<sub>1</sub>
 - 2-stage free power turbine
    - N<sub>f</sub> and N<sub>2</sub>
...
Accessories drive by the `free power turbine`:
...
Checking Oil Level:
 ...
 - Dipstick mounted in filler cap on right side of the aircraft
    ...
    An `overfull condition` is caused by a oil seal failure which allows transmission oil to enter the engine oil system. The sight gauge wil not indicated if the oil level is ABOVE the gauge, just that it's at the gauge. The only indication of a seal failure will be the `overfull` reading on the dipstick.

 - Engine Oil Pump
    - Gear type
    - 1 pressure element
    - 4 scavenge elements
    - driven by [N<sub>g</sub> gear train](#accessory-gearbox) with direct relationship
    - delivers oil under pressure to the `internal oil filter`
...
After the oil is delivered to the engine components it will drain into the sump areas.
 ...
 - Radiator Type Oil Cooler
    - Oil flow is regulated by a `temperature control valve`
       - `approximately 160/71 degrees F/C` the valve starts to open
