...
Hydraulic system reduces pilot workload by reducing control pressures and vibrations generated by the main rotor system.

Hydraulic assisted control is only provided for the cyclic and collective systems.
...
#### Power Pack
 ...
 - Driven by Transmission Accessory Drive Shaft
 - Components
    - Reservoir area
       - finned for heat dissipation
       - air directed from engine oil cooler blower
       - Capacity `~1 pint`
    - Pump section
       - Sends gravity fed hydraulic fluid to pressure regulating valve
    - Pressure regulator valve
       - Regulates system pressure to `600+-50`
       - Sends pressurized fluid to filter
    - Rotor Tachometer Generator mounting pad

#### Hydraulic Filter

**Contains no byass system**. If filter indicator is popped, clean or replace before flight.
...
#### Hydraulic Pressure Switch
 ...
 - Closes when pressure falls below 300 psi
    - Triggers a hydraulic pressure light
    - Light extinguishes when above 400 psi

#### Solenoid Valve

**Spring-loaded to open position and requires electrical power to move the valve to the bypass position**

This 'fail-safe' design ensures the valve is open at all times, unless bypass is selected.

Hydraulic ON - no power is supplied; valve open
